.class public Lmqq/app/BaseFragmentActivity;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lmqq/app/BaseFragmentActivity;->mPermissionCallerMap:Landroid/util/SparseArray;
...
.method private attachDebugUiHierarchyTools(Landroid/app/Activity;)V
    ...
    new-instance v0, Lmqq/app/BaseFragmentActivity$1;

    invoke-direct {v0, p0, p1}, Lmqq/app/BaseFragmentActivity$1;-><init>(Lmqq/app/BaseFragmentActivity;Landroid/app/Activity;)V

    iput-object v0, p0, Lmqq/app/BaseFragmentActivity;->mDebugUiHierarchyBroadcastReceiver:Landroid/content/BroadcastReceiver;
...
.method private detachDebugUiHierarchyTools(Landroid/app/Activity;)V
    ...
    iget-object v0, p0, Lmqq/app/BaseFragmentActivity;->mDebugUiHierarchyBroadcastReceiver:Landroid/content/BroadcastReceiver;
...
.method private isActivityLocaleUpdated(Ljava/util/Locale;)Z
    ...
    sget-object v0, Lmqq/app/BaseFragmentActivity;->locale:Ljava/util/Locale;
    ...
    sget-object v2, Lmqq/app/BaseFragmentActivity;->locale:Ljava/util/Locale;
...
.method private isLocaleCN()Z
    ...
    sget v0, Lmqq/app/BaseFragmentActivity;->localeId:I
...
.method private recreateOnLocaleUpdate()V
    ...
    invoke-virtual {p0}, Lmqq/app/BaseFragmentActivity;->getResources()Landroid/content/res/Resources;
    ...
    invoke-direct {p0, v0}, Lmqq/app/BaseFragmentActivity;->isActivityLocaleUpdated(Ljava/util/Locale;)Z
...
.method public final getAppRuntime()Lmqq/app/AppRuntime;
    ...
    iget-object v0, p0, Lmqq/app/BaseFragmentActivity;->app:Lmqq/app/AppRuntime;
...
.method public getResources()Landroid/content/res/Resources;
    ...
    iget-boolean v0, p0, Lmqq/app/BaseFragmentActivity;->mIsShadow:Z

    if-nez v0, :cond_1

    invoke-direct {p0}, Lmqq/app/BaseFragmentActivity;->isLocaleCN()Z
...
.method public final isResume()Z
    ...
    iget-boolean v0, p0, Lmqq/app/BaseFragmentActivity;->isResume:Z
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    iput-object v0, p0, Lmqq/app/BaseFragmentActivity;->mAndroidOreoUtils:Lmqq/app/AndroidOreoUtils;
    ...
    invoke-virtual {p0}, Lmqq/app/BaseFragmentActivity;->compatibleAndroidOreo()Z
    ...
    iget-object v0, p0, Lmqq/app/BaseFragmentActivity;->mAndroidOreoUtils:Lmqq/app/AndroidOreoUtils;
    ...
    :cond_0
    invoke-virtual {p0, p1}, Lmqq/app/BaseFragmentActivity;->onCreateNoRuntime(Landroid/os/Bundle;)V
    ...
    :cond_1
    invoke-virtual {p0}, Lmqq/app/BaseFragmentActivity;->isLatecyWaitRuntime()Z

    move-result p1

    if-nez p1, :cond_2

    invoke-virtual {p0}, Lmqq/app/BaseFragmentActivity;->waitAppRuntime()Lmqq/app/AppRuntime;
    ...
    invoke-direct {p0, p1}, Lmqq/app/BaseFragmentActivity;->isActivityLocaleUpdated(Ljava/util/Locale;)Z
    ...
    :cond_3
    invoke-direct {p0, p0}, Lmqq/app/BaseFragmentActivity;->attachDebugUiHierarchyTools(Landroid/app/Activity;)V
...
.method public onCreateNoRuntime(Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0}, Lmqq/app/BaseFragmentActivity;->isShadow()Z

    move-result v0

    iput-boolean v0, p0, Lmqq/app/BaseFragmentActivity;->mIsShadow:Z
    ...
    iput-object p1, p0, Lmqq/app/BaseFragmentActivity;->mqq:Lmqq/app/MobileQQ;

    invoke-virtual {p1, p0}, Lmqq/app/MobileQQ;->addBaseActivity(Lmqq/app/BaseFragmentActivity;)V
...
.method public onDestroy()V
    ...
    :cond_1
    invoke-direct {p0, p0}, Lmqq/app/BaseFragmentActivity;->detachDebugUiHierarchyTools(Landroid/app/Activity;)V

    iget-object v0, p0, Lmqq/app/BaseFragmentActivity;->mqq:Lmqq/app/MobileQQ;

    invoke-virtual {v0, p0}, Lmqq/app/MobileQQ;->removeBaseActivity(Lmqq/app/BaseFragmentActivity;)V

    const/4 v0, 0x0

    iput-object v0, p0, Lmqq/app/BaseFragmentActivity;->mqq:Lmqq/app/MobileQQ;
...
.method public onPause()V
    ...
    iput-boolean v0, p0, Lmqq/app/BaseFragmentActivity;->isResume:Z
...
.method public onRequestPermissionsResult(I[Ljava/lang/String;[I)V
    ...
    :cond_0
    iget-object v0, p0, Lmqq/app/BaseFragmentActivity;->mPermissionCallerMap:Landroid/util/SparseArray;
    ...
    iget-object p2, p0, Lmqq/app/BaseFragmentActivity;->mPermissionCallerMap:Landroid/util/SparseArray;
...
.method public onStart()V
    ...
    invoke-direct {p0}, Lmqq/app/BaseFragmentActivity;->recreateOnLocaleUpdate()V
...
.method public varargs requestPermissions(Ljava/lang/Object;I[Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v4}, Lmqq/app/BaseFragmentActivity;->checkSelfPermission(Ljava/lang/String;)I
    ...
    iget-object p3, p0, Lmqq/app/BaseFragmentActivity;->mPermissionCallerMap:Landroid/util/SparseArray;
    ...
    iget-object p1, p0, Lmqq/app/BaseFragmentActivity;->mPermissionCallerMap:Landroid/util/SparseArray;
...
.method public setAppRuntime(Lmqq/app/AppRuntime;)V
    ...
    iput-object p1, p0, Lmqq/app/BaseFragmentActivity;->mProcRuntime:Lmqq/app/AppRuntime;

    if-eqz p1, :cond_0

    invoke-virtual {p0}, Lmqq/app/BaseFragmentActivity;->getModuleId()Ljava/lang/String;
    ...
    :cond_0
    iput-object p1, p0, Lmqq/app/BaseFragmentActivity;->app:Lmqq/app/AppRuntime;
...
.method public waitAppRuntime()Lmqq/app/AppRuntime;
    ...
    :cond_0
    iput-object v0, p0, Lmqq/app/BaseFragmentActivity;->mProcRuntime:Lmqq/app/AppRuntime;
    ...
    iput-object v0, p0, Lmqq/app/BaseFragmentActivity;->app:Lmqq/app/AppRuntime;
