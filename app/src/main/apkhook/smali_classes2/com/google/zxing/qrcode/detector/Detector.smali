...
.method public final a(Lcom/google/zxing/ResultPoint;Lcom/google/zxing/ResultPoint;)F
    ...
    .line 10
    invoke-virtual {p0, v1, p2, v2, p1}, Lcom/google/zxing/qrcode/detector/Detector;->d(IIII)F
...
.method public final b(FIIF)Lcom/google/zxing/qrcode/detector/AlignmentPattern;
    .locals 11
    ...
    .line 3
    iget p2, p2, Lcom/google/zxing/common/BitMatrix;->c:I
    ...
    .line 5
    iget p1, p2, Lcom/google/zxing/qrcode/detector/AlignmentPatternFinder;->c:I

    iget p3, p2, Lcom/google/zxing/qrcode/detector/AlignmentPatternFinder;->f:I

    iget p4, p2, Lcom/google/zxing/qrcode/detector/AlignmentPatternFinder;->e:I

    add-int/2addr p4, p1

    iget v0, p2, Lcom/google/zxing/qrcode/detector/AlignmentPatternFinder;->d:I
    ...
    iget-object v8, p2, Lcom/google/zxing/qrcode/detector/AlignmentPatternFinder;->a:Lcom/google/zxing/common/BitMatrix;

    invoke-virtual {v8, v6, v4}, Lcom/google/zxing/common/BitMatrix;->b(II)Z
    ...
    invoke-virtual {p2, v0}, Lcom/google/zxing/qrcode/detector/AlignmentPatternFinder;->b([I)Z

    move-result v7

    if-eqz v7, :cond_3

    invoke-virtual {p2, v0, v4, v6}, Lcom/google/zxing/qrcode/detector/AlignmentPatternFinder;->c([III)Lcom/google/zxing/qrcode/detector/AlignmentPattern;
    ...
    invoke-virtual {p2, v0, v4, p4}, Lcom/google/zxing/qrcode/detector/AlignmentPatternFinder;->c([III)Lcom/google/zxing/qrcode/detector/AlignmentPattern;
    ...
    :cond_9
    iget-object p1, p2, Lcom/google/zxing/qrcode/detector/AlignmentPatternFinder;->b:Ljava/util/List;
...
.method public final d(IIII)F
    ...
    .line 1
    iget v3, v3, Lcom/google/zxing/common/BitMatrix;->b:I
    ...
    .line 3
    iget v1, v1, Lcom/google/zxing/common/BitMatrix;->c:I
    ...
    .line 4
    invoke-virtual {p0, p1, p2, p3, v1}, Lcom/google/zxing/qrcode/detector/Detector;->c(IIII)F
