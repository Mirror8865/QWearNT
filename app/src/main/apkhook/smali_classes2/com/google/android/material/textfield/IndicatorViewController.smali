...
.method public constructor <init>(Lcom/google/android/material/textfield/TextInputLayout;)V
    ...
    iput p1, p0, Lcom/google/android/material/textfield/IndicatorViewController;->g:F
...
.method public b()V
    ...
    invoke-static {v2}, Lcom/google/android/material/resources/MaterialResources;->f(Landroid/content/Context;)Z
    ...
    invoke-virtual {p0, v2, v5, v4}, Lcom/google/android/material/textfield/IndicatorViewController;->h(ZII)I

    move-result v4

    const v6, 0x7e070476

    iget-object v7, p0, Lcom/google/android/material/textfield/IndicatorViewController;->a:Landroid/content/Context;
    ...
    invoke-virtual {p0, v2, v6, v7}, Lcom/google/android/material/textfield/IndicatorViewController;->h(ZII)I
    ...
    invoke-virtual {p0, v2, v5, v0}, Lcom/google/android/material/textfield/IndicatorViewController;->h(ZII)I
...
.method public c()V
    ...
    iget-object v0, p0, Lcom/google/android/material/textfield/IndicatorViewController;->f:Landroid/animation/Animator;
...
.method public final d(Ljava/util/List;ZLandroid/widget/TextView;III)V
    ...
    iget v0, p0, Lcom/google/android/material/textfield/IndicatorViewController;->g:F
...
.method public e()Z
    ...
    .line 1
    iget-object v0, p0, Lcom/google/android/material/textfield/IndicatorViewController;->l:Landroid/widget/TextView;

    if-eqz v0, :cond_0

    iget-object v0, p0, Lcom/google/android/material/textfield/IndicatorViewController;->j:Ljava/lang/CharSequence;
...
.method public final h(ZII)I
    ...
    iget-object p1, p0, Lcom/google/android/material/textfield/IndicatorViewController;->a:Landroid/content/Context;
...
.method public i()V
    ...
    iput-object v0, p0, Lcom/google/android/material/textfield/IndicatorViewController;->j:Ljava/lang/CharSequence;

    invoke-virtual {p0}, Lcom/google/android/material/textfield/IndicatorViewController;->c()V

    iget v1, p0, Lcom/google/android/material/textfield/IndicatorViewController;->h:I
    ...
    iget-object v1, p0, Lcom/google/android/material/textfield/IndicatorViewController;->p:Ljava/lang/CharSequence;
    ...
    :goto_0
    iput v1, p0, Lcom/google/android/material/textfield/IndicatorViewController;->i:I
    ...
    invoke-virtual {p0, v3, v0}, Lcom/google/android/material/textfield/IndicatorViewController;->k(Landroid/widget/TextView;Ljava/lang/CharSequence;)Z

    move-result v0

    invoke-virtual {p0, v1, v2, v0}, Lcom/google/android/material/textfield/IndicatorViewController;->l(IIZ)V
...
.method public final l(IIZ)V
    ...
    iput-object v12, v7, Lcom/google/android/material/textfield/IndicatorViewController;->f:Landroid/animation/Animator;
    ...
    invoke-virtual/range {v0 .. v6}, Lcom/google/android/material/textfield/IndicatorViewController;->d(Ljava/util/List;ZLandroid/widget/TextView;III)V

    iget-boolean v2, v7, Lcom/google/android/material/textfield/IndicatorViewController;->k:Z

    iget-object v3, v7, Lcom/google/android/material/textfield/IndicatorViewController;->l:Landroid/widget/TextView;

    const/4 v4, 0x1

    invoke-virtual/range {v0 .. v6}, Lcom/google/android/material/textfield/IndicatorViewController;->d(Ljava/util/List;ZLandroid/widget/TextView;III)V

    invoke-static {v12, v13}, Lcom/google/android/material/animation/AnimatorSetCompat;->a(Landroid/animation/AnimatorSet;Ljava/util/List;)V

    invoke-virtual {p0, p1}, Lcom/google/android/material/textfield/IndicatorViewController;->f(I)Landroid/widget/TextView;

    move-result-object v3

    invoke-virtual {p0, v9}, Lcom/google/android/material/textfield/IndicatorViewController;->f(I)Landroid/widget/TextView;
    ...
    :cond_4
    iput v9, v7, Lcom/google/android/material/textfield/IndicatorViewController;->h:I
