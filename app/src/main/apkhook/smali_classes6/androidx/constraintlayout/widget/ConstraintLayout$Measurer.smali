...
.method public final a()V
    ...
    invoke-virtual {v3}, Landroidx/constraintlayout/widget/Placeholder;->a()V
    ...
    invoke-virtual {v2}, Landroidx/constraintlayout/widget/ConstraintHelper;->m()V
...
.method public final b(Landroidx/constraintlayout/solver/widgets/ConstraintWidget;Landroidx/constraintlayout/solver/widgets/analyzer/BasicMeasure$Measure;)V
    ...
    .line 1
    :cond_0
    iget v4, v1, Landroidx/constraintlayout/solver/widgets/ConstraintWidget;->h0:I
    ...
    .line 2
    iget-boolean v4, v1, Landroidx/constraintlayout/solver/widgets/ConstraintWidget;->z:Z

    if-nez v4, :cond_1

    .line 3
    iput v6, v2, Landroidx/constraintlayout/solver/widgets/analyzer/BasicMeasure$Measure;->e:I

    iput v6, v2, Landroidx/constraintlayout/solver/widgets/analyzer/BasicMeasure$Measure;->f:I

    iput v6, v2, Landroidx/constraintlayout/solver/widgets/analyzer/BasicMeasure$Measure;->g:I

    return-void

    .line 4
    :cond_1
    iget-object v4, v1, Landroidx/constraintlayout/solver/widgets/ConstraintWidget;->P:Landroidx/constraintlayout/solver/widgets/ConstraintWidget;
    ...
    iget v7, v2, Landroidx/constraintlayout/solver/widgets/analyzer/BasicMeasure$Measure;->c:I

    iget v8, v2, Landroidx/constraintlayout/solver/widgets/analyzer/BasicMeasure$Measure;->d:I
    ...
    .line 6
    iget-object v11, v1, Landroidx/constraintlayout/solver/widgets/ConstraintWidget;->f0:Ljava/lang/Object;
    ...
    iget v7, v1, Landroidx/constraintlayout/solver/widgets/ConstraintWidget;->l:I
    ...
    :goto_1
    iget v10, v2, Landroidx/constraintlayout/solver/widgets/analyzer/BasicMeasure$Measure;->j:I
    ...
    :cond_10
    iget v6, v0, Landroidx/constraintlayout/widget/ConstraintLayout$Measurer;->g:I

    .line 10
    iget-object v8, v1, Landroidx/constraintlayout/solver/widgets/ConstraintWidget;->D:Landroidx/constraintlayout/solver/widgets/ConstraintAnchor;

    if-eqz v8, :cond_11

    iget-object v8, v1, Landroidx/constraintlayout/solver/widgets/ConstraintWidget;->E:Landroidx/constraintlayout/solver/widgets/ConstraintAnchor;
    ...
    :goto_8
    iget-object v10, v1, Landroidx/constraintlayout/solver/widgets/ConstraintWidget;->F:Landroidx/constraintlayout/solver/widgets/ConstraintAnchor;

    if-eqz v10, :cond_12

    iget-object v10, v1, Landroidx/constraintlayout/solver/widgets/ConstraintWidget;->G:Landroidx/constraintlayout/solver/widgets/ConstraintAnchor;

    iget v10, v10, Landroidx/constraintlayout/solver/widgets/ConstraintAnchor;->g:I
    ...
    .line 12
    :goto_10
    iget-object v6, v1, Landroidx/constraintlayout/solver/widgets/ConstraintWidget;->P:Landroidx/constraintlayout/solver/widgets/ConstraintWidget;
    ...
    .line 15
    invoke-static {v8, v9}, Landroidx/constraintlayout/solver/widgets/Optimizer;->b(II)Z
    ...
    invoke-virtual {v6}, Landroidx/constraintlayout/solver/widgets/ConstraintWidget;->v()I
    ...
    .line 16
    iget v8, v1, Landroidx/constraintlayout/solver/widgets/ConstraintWidget;->a0:I

    if-ne v6, v8, :cond_1e

    .line 17
    invoke-virtual/range {p1 .. p1}, Landroidx/constraintlayout/solver/widgets/ConstraintWidget;->C()Z
    ...
    .line 18
    iget v6, v1, Landroidx/constraintlayout/solver/widgets/ConstraintWidget;->B:I
    ...
    invoke-virtual {v0, v6, v7, v8}, Landroidx/constraintlayout/widget/ConstraintLayout$Measurer;->c(III)Z
    ...
    .line 20
    iget v6, v1, Landroidx/constraintlayout/solver/widgets/ConstraintWidget;->C:I
    ...
    invoke-virtual {v0, v6, v10, v8}, Landroidx/constraintlayout/widget/ConstraintLayout$Measurer;->c(III)Z
    ...
    .line 22
    iget v1, v1, Landroidx/constraintlayout/solver/widgets/ConstraintWidget;->a0:I
    ...
    iget v9, v1, Landroidx/constraintlayout/solver/widgets/ConstraintWidget;->S:F
    ...
    iget v12, v1, Landroidx/constraintlayout/solver/widgets/ConstraintWidget;->S:F
    ...
    iget v8, v1, Landroidx/constraintlayout/solver/widgets/ConstraintWidget;->l:I

    if-nez v8, :cond_29

    if-eqz v6, :cond_29

    iget v6, v1, Landroidx/constraintlayout/solver/widgets/ConstraintWidget;->m:I
    ...
    invoke-virtual {v8, v6, v7, v10}, Landroidx/constraintlayout/widget/VirtualLayout;->p(Landroidx/constraintlayout/solver/widgets/VirtualLayout;II)V
    ...
    .line 24
    :goto_1b
    iput v7, v1, Landroidx/constraintlayout/solver/widgets/ConstraintWidget;->B:I

    iput v10, v1, Landroidx/constraintlayout/solver/widgets/ConstraintWidget;->C:I
    ...
    iget v14, v1, Landroidx/constraintlayout/solver/widgets/ConstraintWidget;->o:I
    ...
    :goto_1c
    iget v15, v1, Landroidx/constraintlayout/solver/widgets/ConstraintWidget;->p:I
    ...
    :goto_1d
    iget v7, v1, Landroidx/constraintlayout/solver/widgets/ConstraintWidget;->s:I
    ...
    :cond_2e
    iget-object v7, v0, Landroidx/constraintlayout/widget/ConstraintLayout$Measurer;->h:Landroidx/constraintlayout/widget/ConstraintLayout;
    ...
    .line 28
    invoke-static {v7, v0}, Landroidx/constraintlayout/solver/widgets/Optimizer;->b(II)Z
    ...
    .line 30
    iput-boolean v10, v1, Landroidx/constraintlayout/solver/widgets/ConstraintWidget;->g:Z
    ...
    :goto_22
    iget v3, v2, Landroidx/constraintlayout/solver/widgets/analyzer/BasicMeasure$Measure;->c:I

    if-ne v14, v3, :cond_37

    iget v3, v2, Landroidx/constraintlayout/solver/widgets/analyzer/BasicMeasure$Measure;->d:I
    ...
    :cond_39
    iput v14, v2, Landroidx/constraintlayout/solver/widgets/analyzer/BasicMeasure$Measure;->e:I

    iput v15, v2, Landroidx/constraintlayout/solver/widgets/analyzer/BasicMeasure$Measure;->f:I

    iput-boolean v0, v2, Landroidx/constraintlayout/solver/widgets/analyzer/BasicMeasure$Measure;->h:Z

    iput v13, v2, Landroidx/constraintlayout/solver/widgets/analyzer/BasicMeasure$Measure;->g:I
