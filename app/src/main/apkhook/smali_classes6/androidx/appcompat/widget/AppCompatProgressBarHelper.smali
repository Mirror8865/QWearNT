...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Landroidx/appcompat/widget/AppCompatProgressBarHelper;->a:[I
...
.method public constructor <init>(Landroid/widget/ProgressBar;)V
    ...
    iput-object p1, p0, Landroidx/appcompat/widget/AppCompatProgressBarHelper;->b:Landroid/widget/ProgressBar;
...
.method public a(Landroid/util/AttributeSet;I)V
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/AppCompatProgressBarHelper;->b:Landroid/widget/ProgressBar;

    invoke-virtual {v0}, Landroid/widget/ProgressBar;->getContext()Landroid/content/Context;

    move-result-object v0

    sget-object v1, Landroidx/appcompat/widget/AppCompatProgressBarHelper;->a:[I

    const/4 v2, 0x0

    invoke-static {v0, p1, v1, p2, v2}, Landroidx/appcompat/widget/TintTypedArray;->q(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroidx/appcompat/widget/TintTypedArray;
    ...
    iget-object v1, p0, Landroidx/appcompat/widget/AppCompatProgressBarHelper;->b:Landroid/widget/ProgressBar;
    ...
    invoke-virtual {p0, v7, v0}, Landroidx/appcompat/widget/AppCompatProgressBarHelper;->b(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    :cond_2
    invoke-virtual {p1, v0}, Landroidx/appcompat/widget/TintTypedArray;->h(I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {p0, p2, v2}, Landroidx/appcompat/widget/AppCompatProgressBarHelper;->b(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
...
.method public final b(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    iget-object v2, p0, Landroidx/appcompat/widget/AppCompatProgressBarHelper;->c:Landroid/graphics/Bitmap;

    if-nez v2, :cond_6

    iput-object v0, p0, Landroidx/appcompat/widget/AppCompatProgressBarHelper;->c:Landroid/graphics/Bitmap;
