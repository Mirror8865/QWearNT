...
.method public jumpDrawablesToCurrentState()V
    ...
    :cond_1
    iget-object v0, p0, Landroidx/appcompat/widget/SwitchCompat;->C:Landroid/animation/ObjectAnimator;
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/SwitchCompat;->C:Landroid/animation/ObjectAnimator;
...
.method public onLayout(ZIIII)V
    ...
    invoke-static {p1}, Landroidx/appcompat/widget/DrawableUtils;->c(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Rect;
    ...
    iput p3, p0, Landroidx/appcompat/widget/SwitchCompat;->x:I

    iput p4, p0, Landroidx/appcompat/widget/SwitchCompat;->z:I
...
.method public onMeasure(II)V
    ...
    iget-object p1, p0, Landroidx/appcompat/widget/SwitchCompat;->A:Landroid/text/Layout;

    if-nez p1, :cond_0

    iget-object p1, p0, Landroidx/appcompat/widget/SwitchCompat;->r:Ljava/lang/CharSequence;

    invoke-virtual {p0, p1}, Landroidx/appcompat/widget/SwitchCompat;->c(Ljava/lang/CharSequence;)Landroid/text/Layout;

    move-result-object p1

    iput-object p1, p0, Landroidx/appcompat/widget/SwitchCompat;->A:Landroid/text/Layout;

    :cond_0
    iget-object p1, p0, Landroidx/appcompat/widget/SwitchCompat;->B:Landroid/text/Layout;
    ...
    iput-object p1, p0, Landroidx/appcompat/widget/SwitchCompat;->B:Landroid/text/Layout;
    ...
    iget-object v1, p0, Landroidx/appcompat/widget/SwitchCompat;->B:Landroid/text/Layout;
...
.method public setChecked(Z)V
    ...
    .line 1
    :goto_1
    sget-object p1, Landroidx/appcompat/widget/SwitchCompat;->b:Landroid/util/Property;
    ...
    iput-object p1, p0, Landroidx/appcompat/widget/SwitchCompat;->C:Landroid/animation/ObjectAnimator;

    const-wide/16 v1, 0xfa

    invoke-virtual {p1, v1, v2}, Landroid/animation/ObjectAnimator;->setDuration(J)Landroid/animation/ObjectAnimator;

    iget-object p1, p0, Landroidx/appcompat/widget/SwitchCompat;->C:Landroid/animation/ObjectAnimator;
