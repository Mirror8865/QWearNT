...
.field public k:Landroidx/appcompat/widget/TooltipPopup;
...
.method public constructor <init>(Landroid/view/View;Ljava/lang/CharSequence;)V
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/TooltipCompatHandler;->g:Ljava/lang/Runnable;
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/TooltipCompatHandler;->h:Ljava/lang/Runnable;

    iput-object p1, p0, Landroidx/appcompat/widget/TooltipCompatHandler;->d:Landroid/view/View;

    iput-object p2, p0, Landroidx/appcompat/widget/TooltipCompatHandler;->e:Ljava/lang/CharSequence;
...
.method public static c(Landroidx/appcompat/widget/TooltipCompatHandler;)V
    .locals 3
    ...
    iget-object v0, v0, Landroidx/appcompat/widget/TooltipCompatHandler;->g:Ljava/lang/Runnable;
    ...
    iget-object p0, p0, Landroidx/appcompat/widget/TooltipCompatHandler;->g:Ljava/lang/Runnable;
...
.method public final a()V
    ...
    iput v0, p0, Landroidx/appcompat/widget/TooltipCompatHandler;->i:I
...
.method public b()V
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/TooltipCompatHandler;->k:Landroidx/appcompat/widget/TooltipPopup;

    if-eqz v0, :cond_0

    invoke-virtual {v0}, Landroidx/appcompat/widget/TooltipPopup;->a()V

    iput-object v1, p0, Landroidx/appcompat/widget/TooltipCompatHandler;->k:Landroidx/appcompat/widget/TooltipPopup;
    ...
    iget-object v1, p0, Landroidx/appcompat/widget/TooltipCompatHandler;->h:Ljava/lang/Runnable;
...
.method public d(Z)V
    ...
    invoke-virtual {v1}, Landroidx/appcompat/widget/TooltipCompatHandler;->b()V
    ...
    iput-boolean v1, v0, Landroidx/appcompat/widget/TooltipCompatHandler;->l:Z
    ...
    iput-object v1, v0, Landroidx/appcompat/widget/TooltipCompatHandler;->k:Landroidx/appcompat/widget/TooltipPopup;

    iget-object v2, v0, Landroidx/appcompat/widget/TooltipCompatHandler;->d:Landroid/view/View;

    iget v3, v0, Landroidx/appcompat/widget/TooltipCompatHandler;->i:I

    iget v4, v0, Landroidx/appcompat/widget/TooltipCompatHandler;->j:I

    iget-boolean v5, v0, Landroidx/appcompat/widget/TooltipCompatHandler;->l:Z

    iget-object v6, v0, Landroidx/appcompat/widget/TooltipCompatHandler;->e:Ljava/lang/CharSequence;

    .line 1
    iget-object v7, v1, Landroidx/appcompat/widget/TooltipPopup;->b:Landroid/view/View;
    ...
    .line 2
    invoke-virtual {v1}, Landroidx/appcompat/widget/TooltipPopup;->a()V

    :cond_3
    iget-object v7, v1, Landroidx/appcompat/widget/TooltipPopup;->c:Landroid/widget/TextView;

    invoke-virtual {v7, v6}, Landroid/widget/TextView;->setText(Ljava/lang/CharSequence;)V

    iget-object v6, v1, Landroidx/appcompat/widget/TooltipPopup;->d:Landroid/view/WindowManager$LayoutParams;
    ...
    iget-object v7, v1, Landroidx/appcompat/widget/TooltipPopup;->a:Landroid/content/Context;

    invoke-virtual {v7}, Landroid/content/Context;->getResources()Landroid/content/res/Resources;

    move-result-object v7

    const v10, 0x7e0709a6
    ...
    const v12, 0x7e0709a9

    goto :goto_3

    :cond_6
    const v12, 0x7e0709a8
    ...
    :cond_a
    iget-object v13, v1, Landroidx/appcompat/widget/TooltipPopup;->e:Landroid/graphics/Rect;
    ...
    iget-object v13, v1, Landroidx/appcompat/widget/TooltipPopup;->a:Landroid/content/Context;
    ...
    iget-object v14, v1, Landroidx/appcompat/widget/TooltipPopup;->e:Landroid/graphics/Rect;
    ...
    :cond_c
    iget-object v11, v1, Landroidx/appcompat/widget/TooltipPopup;->g:[I

    invoke-virtual {v12, v11}, Landroid/view/View;->getLocationOnScreen([I)V

    iget-object v11, v1, Landroidx/appcompat/widget/TooltipPopup;->f:[I

    invoke-virtual {v2, v11}, Landroid/view/View;->getLocationOnScreen([I)V

    iget-object v2, v1, Landroidx/appcompat/widget/TooltipPopup;->f:[I

    aget v11, v2, v8

    iget-object v13, v1, Landroidx/appcompat/widget/TooltipPopup;->g:[I
    ...
    iget-object v3, v1, Landroidx/appcompat/widget/TooltipPopup;->b:Landroid/view/View;

    invoke-virtual {v3, v2, v2}, Landroid/view/View;->measure(II)V

    iget-object v2, v1, Landroidx/appcompat/widget/TooltipPopup;->b:Landroid/view/View;

    invoke-virtual {v2}, Landroid/view/View;->getMeasuredHeight()I

    move-result v2

    iget-object v3, v1, Landroidx/appcompat/widget/TooltipPopup;->f:[I
    ...
    iget-object v4, v1, Landroidx/appcompat/widget/TooltipPopup;->e:Landroid/graphics/Rect;
    ...
    .line 6
    :goto_8
    iget-object v2, v1, Landroidx/appcompat/widget/TooltipPopup;->a:Landroid/content/Context;
    ...
    iget-object v1, v1, Landroidx/appcompat/widget/TooltipPopup;->d:Landroid/view/WindowManager$LayoutParams;
    ...
    iget-boolean v1, v0, Landroidx/appcompat/widget/TooltipCompatHandler;->l:Z
    ...
    iget-object v4, v0, Landroidx/appcompat/widget/TooltipCompatHandler;->h:Ljava/lang/Runnable;
...
.method public onHover(Landroid/view/View;Landroid/view/MotionEvent;)Z
    ...
    iget-object p1, p0, Landroidx/appcompat/widget/TooltipCompatHandler;->k:Landroidx/appcompat/widget/TooltipPopup;

    const/4 v0, 0x0

    if-eqz p1, :cond_0

    iget-boolean p1, p0, Landroidx/appcompat/widget/TooltipCompatHandler;->l:Z
    ...
    iget v1, p0, Landroidx/appcompat/widget/TooltipCompatHandler;->i:I
    ...
    iget v2, p0, Landroidx/appcompat/widget/TooltipCompatHandler;->f:I
    ...
    :cond_4
    iput p1, p0, Landroidx/appcompat/widget/TooltipCompatHandler;->i:I

    iput p2, p0, Landroidx/appcompat/widget/TooltipCompatHandler;->j:I
    ...
    .line 2
    invoke-static {p0}, Landroidx/appcompat/widget/TooltipCompatHandler;->c(Landroidx/appcompat/widget/TooltipCompatHandler;)V
...
.method public onLongClick(Landroid/view/View;)Z
    ...
    invoke-virtual {p0, v0}, Landroidx/appcompat/widget/TooltipCompatHandler;->d(Z)V
